 ...
 */
public class GridSchedulerProxy extends UnicastRemoteObject  {
	...
	public GridSchedulerProxy(@NotNull RmiServer rmiServer, @NotNull String url, @NotNull String driverUrl)
