...
//                ResourceManager rmImpl = new ResourceManager(idRM, 10000, server, RMURL, repoGS);
...
////                restart = true;
////                try {
////                    ResourceManager rmImpl = new ResourceManager(0, 10000, server, urlRM0, gridSchedulerRepository);
